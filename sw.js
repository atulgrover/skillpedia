const CACHE_NAME = 'skillpedia-v11.0-network-first';
...
self.addEventListener('install', (event) => {
  console.log('[SW] Installing skillpedia-v11.0-network-first');
  event.waitUntil(
...
self.addEventListener('activate', (event) => {
  console.log('[SW] Activating skillpedia-v11.0-network-first & deleting old caches');
  event.waitUntil(
